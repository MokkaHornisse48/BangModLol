...
import mod.milog.bangmod.items.Items;
import mod.milog.bangmod.BangMod;
import mod.milog.bangmod.entitys.DodoEntity;
...
@Mod.EventBusSubscriber(modid = BangMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
