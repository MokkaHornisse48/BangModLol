...
public class Entitys {
    ...
    public static final EntityType<DodoEggEntity> DodoEggEntity = (EntityType<DodoEggEntity>) EntityType.Builder.<DodoEggEntity>create(DodoEggEntity::new,EntityClassification.MISC).size(0.7F, 1.8F).build(new ResourceLocation(Theonetest.MOD_ID, "dodo_egg").toString()).setRegistryName(new ResourceLocation(Theonetest.MOD_ID, "dodo_egg"));
}
